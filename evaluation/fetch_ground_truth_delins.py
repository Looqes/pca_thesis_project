...
path_to_put_prostate_delineations = f"./contours_compare_{test_or_val}/{dataset}/prostate_delineations"
...
if downscale == "yes":
    image_scaling.downscale_prostate_delineations_to_region_delineations(
        path_to_put_prostate_delineations,
        f"./contours_compare_{test_or_val}/{dataset}/downscaled_prostate_delineations"
    )
