...
full_datasetname = "Dataset001_pca"

if os.path.exists(f"{PATH_TO_NNUNET_RAW}/{full_datasetname}"):
    ...
    # adc_dataset_path = f"{PATH_TO_NNUNET_RAW}/Dataset004_pcasplitmodal"
    # perfusion_dataset_path = f"{PATH_TO_NNUNET_RAW}/Dataset005_pcasplitmodal"
